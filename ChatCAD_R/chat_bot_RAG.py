...
class gpt_bot(base_bot):
    ...
    def chat_report(self,message: str, ref_record: str):
        ...
        topic_range=query_range(self.sent_model,refined_message,k=5,bar=0.6)
    ...
    def chat(self,message: str, ref_record: str):
        ...
        if ret==None:
            ...
            response = self.chat_with_gpt(chat_message)
            message= response+f"\nNote: Relevant information is sourced from the Merck Manual Professional Version. ({needed_site})"+""
